    ...
    items: [
      {
        ...
        faqsEn: [
          ...
          {
            question: "Can mothers who had a cesarean section use this service?",
            answer:
...

      {
        ...
        shortDescription:          "Massage lưng thư giãn giúp mẹ sau sinh giải tỏa căng thẳng, giảm đau nhức vùng lưng và vai do tư thế cho con bú, bế ẵm, đồng thời cải thiện chất lượng giấc ngủ.",

        shortDescriptionEn: "Relaxing back massage helps postpartum mothers relieve stress, reduce back and shoulder pain caused by breastfeeding and carrying the baby, and improve sleep quality.",
        ...
        faqsEn: [
          {
            question: "Is this service suitable for mothers who had a cesarean section?",
            answer:
...

      {
        ...
        shortDescription:"Dịch vụ massage hỗ trợ thông tắc tia sữa giúp mẹ giải quyết tình trạng căng tức ngực, tắc tia sữa và viêm tuyến vú — bảo vệ sức khỏe mẹ và duy trì nguồn sữa dồi dào cho bé.",

        shortDescriptionEn: "Breast massage for milk duct relief helps mothers manage breast fullness, blocked milk ducts, and breast inflammation while supporting breastfeeding.",
        ...
        description:          "Tắc tia sữa là tình trạng phổ biến nhưng gây nhiều lo lắng và khó chịu cho mẹ sau sinh. Nếu không được xử lý kịp thời, có thể dẫn đến viêm tuyến vú nghiêm trọng. Đội ngũ chuyên viên Maia Care được đào tạo chuyên sâu về kỹ thuật massage thông tia sữa, giúp mẹ giải quyết hiệu quả tình trạng này một cách nhẹ nhàng và an toàn nhất.",

        descriptionEn: "Blocked milk ducts are common after childbirth and can cause significant discomfort and concern. If not addressed appropriately, they may contribute to breast inflammation. Maia Care professionals are trained in gentle breast massage techniques to support milk duct relief safely and comfortably.",
...

      {
        ...
        shortDescription:          "Dịch vụ chăm sóc vết khâu tầng sinh môn và vết mổ lấy thai của Maia Care giúp vết thương mau lành, phòng ngừa nhiễm trùng và hỗ trợ mẹ phục hồi nhanh hơn.",
        shortDescriptionEn: "Maia Care's postpartum stitch and C-section incision care helps support wound healing, reduce infection risk, and promote a smoother recovery.",
        ...
        description:          "Vết thương sau sinh cần được chăm sóc đúng cách để lành nhanh và tránh biến chứng. Maia Care cung cấp dịch vụ vệ sinh, thay băng và chăm sóc vết khâu tầng sinh môn (mẹ sinh thường) hoặc vết mổ bụng (mẹ sinh mổ) theo đúng quy trình vô khuẩn, sử dụng vật tư y tế đạt chuẩn.",

        descriptionEn: "Postpartum wounds require appropriate care to support healing and reduce complications. Maia Care provides cleaning, dressing changes, and care for perineal stitches after vaginal delivery or abdominal incisions after cesarean delivery, following appropriate sterile procedures and using standard medical supplies.",
        ...
        faqsEn: [
          ...
          {
            question: "How can I tell whether the incision is healing normally?",
            answer:
    ...
    items: [
      {
        ...
        nameEn: "Health Check-up and Consultation",
        price: "390,000đ",
        priceUnit: "buổi",
        ...
        shortDescription:          "Dịch vụ kiểm tra và tư vấn sức khỏe cho bé sơ sinh giúp ba mẹ theo dõi sự phát triển của bé, nhận biết sớm các dấu hiệu bất thường và được tư vấn chăm sóc phù hợp.",

        shortDescriptionEn: "Newborn health check-ups and consultations help parents monitor their baby's development, identify possible concerns early, and receive appropriate care guidance.",
        ...
        description:          "Kiểm tra sức khỏe định kỳ và tư vấn chăm sóc bé sơ sinh là điều vô cùng quan trọng trong những tháng đầu đời. Đội ngũ chuyên viên Maia Care đánh giá toàn diện các chỉ số phát triển của bé, bao gồm cân nặng, chiều cao, phản xạ, màu da, rốn và các dấu hiệu sinh tồn cơ bản, đồng thời tư vấn ba mẹ cách chăm sóc đúng theo từng giai đoạn.",

        descriptionEn: "Regular health checks and newborn care guidance are especially important during the first months of life. Maia Care professionals review key developmental indicators such as weight, length, reflexes, skin color, umbilical cord condition, and basic vital signs, while guiding parents on age-appropriate care.",
...

      {
        ...
        shortDescription:          "Tắm thủy liệu cho bé là trải nghiệm tắm nước ấm đặc biệt trong bồn thủy liệu chuyên dụng, giúp bé thư giãn, kích thích phát triển thần kinh vận động và tăng sức đề kháng.",
        shortDescriptionEn: "Baby hydrotherapy is a warm-water bathing experience in a specialized hydrotherapy tub that helps babies relax and supports natural motor development.",
        ...
        description: "Tắm thủy liệu (Hydrotherapy) cho bé sơ sinh là phương pháp tắm trong bồn nước ấm với vòng nổi chuyên dụng, mô phỏng môi trường nước ối trong bụng mẹ. Phương pháp này đã được nghiên cứu khoa học chứng minh giúp bé ngủ ngon hơn, giảm quấy khóc, kích thích vận động tự nhiên và tăng cường phát triển thần kinh cơ.",
        descriptionEn: "Baby hydrotherapy is a warm-water bathing method using a specialized float ring and tub. The gentle water environment allows babies to move naturally while receiving supervised care in a calm and comfortable setting.",
        ...
        faqs: [
          ...
          },
          {
            ...
            answer:
              "Khuyến nghị 2–3 lần/tuần để đạt hiệu quả tốt nhất.",
          },
          {
...

      {
        ...
        shortDescription:          "Massage cho bé sơ sinh kích thích phát triển toàn diện, giúp bé tăng cân, ngủ ngon, giảm đầy hơi và xây dựng kết nối cảm xúc với ba mẹ.",

        shortDescriptionEn: "Baby massage supports relaxation and development, and may help babies sleep better, reduce gas discomfort, and strengthen emotional bonding with parents.",
        ...
        description:          "Massage cho bé sơ sinh là liệu pháp xúc giác đã được y học hiện đại công nhận với nhiều lợi ích cho sự phát triển của trẻ. Chuyên viên Maia Care thực hiện kỹ thuật massage nhẹ nhàng, sử dụng dầu massage tự nhiên an toàn, kết hợp hướng dẫn ba mẹ để có thể tiếp tục thực hành tại nhà.",

        descriptionEn: "Baby massage is a gentle touch-based care practice that can support a baby's comfort and development. Maia Care professionals use gentle techniques and suitable natural massage oil, while also teaching parents basic techniques they can continue practicing at home.",
        ...
        faqs: [
          {
            ...
            answer:
              "Từ 2 tuần tuổi trở lên, sau khi rốn đã rụng hoàn toàn.",
          },
          {
      ...
      {
        id: 3,
        name: "Chăm sóc bé tại nhà theo giờ",
        nameEn: "Hourly In-Home Baby Care",
        price: "390,000đ",
        priceUnit: "giờ",
        duration: "Theo nhu cầu (tối thiểu 2 giờ)",
        durationEn: "As needed (minimum 2 hours)",
        location: "Tại nhà",
        locationEn: "At home",
        ...
        shortDescription:          "Dịch vụ chăm sóc bé tại nhà theo giờ của Maia Care cung cấp chuyên viên có kinh nghiệm đến nhà hỗ trợ ba mẹ chăm sóc bé trong khoảng thời gian cần thiết.",
        shortDescriptionEn: "Maia Care's hourly in-home baby care provides an experienced professional to support parents with baby care whenever help is needed.",
        ...
        description:          "Ba mẹ có thể cần thời gian nghỉ ngơi, xử lý công việc hoặc cần hỗ trợ chăm sóc bé trong những lúc đặc biệt. Maia Care cung cấp dịch vụ chăm sóc bé tại nhà theo giờ với chuyên viên giàu kinh nghiệm, được kiểm tra lý lịch và đào tạo bài bản.",

        descriptionEn: "Parents may need time to rest, work, or handle special situations while still ensuring their baby receives attentive care. Maia Care provides hourly in-home baby care with experienced professionals who are background-checked and properly trained.",
        ...
        faqs: [
          {
            ...
            answer:
              "Tối thiểu 2 giờ mỗi ca để đảm bảo chất lượng chăm sóc.",
          },
          {
    ...
    items: [
      {
        ...
        shortDescription:          'Combo "Mẹ khỏe - Bé yêu" kết hợp chăm sóc toàn diện cho cả mẹ và bé trong cùng một buổi, tiết kiệm thời gian và chi phí.',

        shortDescriptionEn: "The Healthy Mom – Happy Baby Package combines comprehensive care for both mother and baby in one session, saving time and cost.",
        ...
        process: [
          ...
          },
          {
            ...
            detail:
              "Tắm, massage và kiểm tra sức khỏe cơ bản cho bé.",
          },
          {
            step: "04",
...

      {
        ...
        shortDescription:          "Combo tập trung vào phục hồi sau sinh cho mẹ kết hợp chăm sóc sức khỏe toàn diện cho bé, đặc biệt phù hợp trong 4–8 tuần đầu sau sinh.",

        shortDescriptionEn: "This package focuses on postpartum recovery for the mother while providing comprehensive baby care, making it especially suitable for the first 4–8 weeks after childbirth.",
        ...
        description:          'Gói "Mẹ phục hồi - Bé khỏe" được thiết kế đặc biệt cho giai đoạn 4–8 tuần sau sinh — thời điểm mẹ cần hỗ trợ phục hồi nhiều nhất. Dịch vụ cho mẹ tập trung vào massage bụng, chăm sóc vết thương và phục hồi thể lực; trong khi đó bé được kiểm tra sức khỏe và tắm massage đúng kỹ thuật.',

        descriptionEn: "The Mom's Recovery – Baby's Health Package is designed for the first 4–8 weeks after childbirth, when mothers often need the most recovery support. Mother's care focuses on abdominal massage, wound care, and physical relaxation, while the baby receives health checks and appropriate bathing and massage.",
        ...
        faqsEn: [
          {
            question: "Is this package suitable for mothers who had a C-section?",
            answer:
...

      {
        ...
        shortDescription:          "Gói chăm sóc toàn diện nhất của Maia Care, bao gồm đầy đủ các dịch vụ cho cả mẹ và bé, đồng hành cùng gia đình trong suốt tháng đầu sau sinh.",

        shortDescriptionEn: "Maia Care's most comprehensive package combines essential services for both mother and baby and supports the family throughout the first month after childbirth.",
        ...
        description:          'Combo "Mẹ và bé toàn diện" là gói dịch vụ đỉnh cao của Maia Care, đảm bảo mẹ và bé được chăm sóc ở mức độ đầy đủ nhất. Mỗi buổi kéo dài 2 giờ với toàn bộ các dịch vụ: chăm sóc phục hồi cho mẹ, kiểm tra sức khỏe, tắm và massage cho bé, tư vấn dinh dưỡng và hỗ trợ tâm lý sau sinh.',

        descriptionEn: "The Complete Mom & Baby Care Package is Maia Care's most comprehensive service option. Each two-hour session combines postpartum recovery care for the mother, baby health checks, baby bathing and massage, nutrition consultation, and postpartum emotional support.",
        ...
        process: [
          ...
          },
          {
            ...
            title: "Chăm sóc bé (45 phút)",
            detail:
              "Kiểm tra sức khỏe, tắm thủy liệu và massage bé.",
          },
          {
            step: "04",
        ...
        faqsEn: [
          ...
          {
            question: "Can this package be given as a birthday or maternity gift?",
            answer:
              "Yes. Maia Care can prepare a gift voucher upon request.",
          },
          {
...

      {
        ...
        shortDescription:          'Gói "Đồng hành sau sinh" cung cấp chuyên viên cố định đến nhà hàng ngày trong tháng đầu, hỗ trợ toàn diện về chăm sóc mẹ, chăm sóc bé và hướng dẫn ba mẹ tự chăm sóc.',

        shortDescriptionEn: "The Postpartum Care Companion Package provides a dedicated professional who visits the home during the first month to support mother and baby care and teach parents essential skills.",
        ...
        features: [
          ...
          { icon: "user", label: "Chuyên viên cố định", labelEn: "Dedicated professional" },
          { icon: "star", label: "Toàn diện", labelEn: "Comprehensive" },
        ],

        description:          'Tháng đầu sau sinh là giai đoạn khó khăn nhất nhưng cũng quan trọng nhất. Gói "Đồng hành sau sinh" của Maia Care cung cấp chuyên viên cố định đến nhà hàng ngày, trở thành người bạn đồng hành tin cậy của gia đình trong suốt giai đoạn này.',

        descriptionEn: "The first month after childbirth can be both challenging and important. Maia Care's Postpartum Care Companion Package provides a dedicated professional who visits the home regularly and becomes a trusted support person for the family during this period.",
        ...
        faqsEn: [
          ...
          {
            question: "What happens if the assigned professional is unavailable?",
            answer:
    ...
    items: [
      {
        ...
        shortDescription:          "Buổi tư vấn dinh dưỡng cá nhân hóa cho mẹ sau sinh, giúp mẹ hiểu rõ nhu cầu dinh dưỡng, xây dựng thực đơn phù hợp và phục hồi sức khỏe nhanh hơn.",

        shortDescriptionEn: "Personalized postpartum nutrition consultation helps mothers understand their nutritional needs, build a suitable meal plan, and support recovery.",
        ...
        description:          "Dinh dưỡng sau sinh đóng vai trò cực kỳ quan trọng trong quá trình phục hồi của mẹ và chất lượng sữa mẹ cho bé. Chuyên gia dinh dưỡng của Maia Care sẽ đánh giá tình trạng sức khỏe, thói quen ăn uống và nhu cầu dinh dưỡng cụ thể của mẹ, từ đó xây dựng kế hoạch ăn uống phù hợp, thực tế và dễ thực hiện.",

        descriptionEn: "Postpartum nutrition plays an important role in maternal recovery and breastfeeding. Maia Care's nutrition specialist reviews the mother's health condition, eating habits, and nutritional needs, then develops a practical and personalized nutrition plan.",
        ...
        faqsEn: [
          ...
          {
            question: "Does the specialist have postpartum nutrition experience?",
            answer:
...

      {
        ...
        shortDescription:          "Gói thực đơn dinh dưỡng chi tiết cho 4 tuần đầu sau sinh, bao gồm thực đơn hàng tuần, danh sách thực phẩm cần mua và hướng dẫn chế biến phù hợp.",

        shortDescriptionEn: "A detailed four-week postpartum nutrition meal plan with weekly menus, a shopping list, and practical preparation guidance.",
        ...
        description:          "Gói thực đơn dinh dưỡng 4 tuần cung cấp kế hoạch ăn uống chi tiết theo từng tuần, bao gồm 3 bữa chính và 2–3 bữa phụ mỗi ngày. Thực đơn được xây dựng dựa trên nguyên liệu phổ biến tại Việt Nam, dễ tìm mua và dễ chế biến, nhưng đảm bảo đủ dinh dưỡng cho mẹ phục hồi và có sữa dồi dào cho bé.",

        descriptionEn: "The four-week nutrition meal plan provides a detailed weekly eating schedule with three main meals and two to three snacks per day. It uses common Vietnamese ingredients that are easy to buy and prepare while supporting the mother's recovery and breastfeeding nutrition.",
...

      {
        ...
        shortDescription:          "Tư vấn dinh dưỡng và xây dựng thực đơn ăn dặm cho bé theo từng giai đoạn phát triển, giúp bé bắt đầu hành trình ăn dặm khoa học, an toàn và ngon miệng.",

        shortDescriptionEn: "Nutrition consultation and weaning meal planning for babies supports a safe, practical, and age-appropriate start to complementary feeding.",
        ...
        features: [
          ...
          { icon: "user", label: "Phù hợp lứa tuổi", labelEn: "Age-appropriate" },
          { icon: "star", label: "Thực tiễn", labelEn: "Practical" },
        ],

        description:          "Ăn dặm là giai đoạn quan trọng trong sự phát triển của bé, bắt đầu từ 4–6 tháng tuổi. Chuyên gia dinh dưỡng của Maia Care sẽ hướng dẫn ba mẹ phương pháp ăn dặm phù hợp (ăn dặm truyền thống, BLW hoặc kết hợp), xây dựng thực đơn theo từng giai đoạn và giải đáp mọi băn khoăn của ba mẹ.",

        descriptionEn: "Complementary feeding is an important stage in a baby's development. Maia Care's nutrition specialist guides parents on appropriate complementary-feeding approaches, helps build age-appropriate meal plans, and answers parents' questions throughout the transition.",
...

      {
        ...
        shortDescription:          "Gói dinh dưỡng toàn diện đồng thời tư vấn cho cả mẹ đang cho con bú và bé đang ăn dặm — đảm bảo nguồn dinh dưỡng tốt nhất cho cả hai trong giai đoạn vàng.",

        shortDescriptionEn: "A coordinated nutrition package for breastfeeding mothers and babies starting complementary feeding, supporting both through an important developmental period.",
        ...
        description:          'Gói "Mẹ khỏe - Bé ăn ngon" là giải pháp dinh dưỡng đồng bộ cho cả mẹ và bé trong giai đoạn vàng 6–12 tháng sau sinh. Chuyên gia sẽ xây dựng kế hoạch dinh dưỡng song song cho mẹ đang cho con bú và thực đơn ăn dặm cho bé, đảm bảo cả hai đều được nuôi dưỡng tối ưu.',

        descriptionEn: "The Healthy Mom – Happy Eater Nutrition Package provides coordinated nutrition support for mother and baby during the important 6–12 month postpartum period. The specialist develops a nutrition plan for the breastfeeding mother alongside complementary-feeding menus for the baby.",
        ...
        faqsEn: [
          ...
          {
            question: "How many consultations are included in the 3-month package?",
            answer:
